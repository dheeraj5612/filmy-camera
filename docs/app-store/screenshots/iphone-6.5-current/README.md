...
Five actual 1242×2688 PNGs from version 1.0.0 (8), captured September 5, 2026 with reversible review look selection and Original comparison. Uploading this replacement pack to App Store Connect remains a separate release gate.
