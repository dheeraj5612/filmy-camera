...
- Current repository evidence: latest verified release implementation commit `615009a8e7d2de8cac2beca0bbf4cec2bae3a3af` on branch `codex/security-hardening-20260813`, with the camera-shell UI revamp, typed FX Blue control, capture identity hardening, accessibility coverage, and team-aligned release configuration.
