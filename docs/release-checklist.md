...
- [x] Run the iPhone Simulator build and XCTest workflow locally (41 unit/renderer tests plus 2 UI tests, 43 total, on iOS 18.5 and iOS 26.5 runtimes).
