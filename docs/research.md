...
The renderer version advanced to `core-image-parametric-v10` on that branch; merged into the build 22 line (v17) it ships as `core-image-parametric-v18`, which
