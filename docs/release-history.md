# Filmy Camera release history

> Historical snapshot preserved from `release-checklist.md` on September 4, 2026. Statements such as “current,” checked boxes, artifact paths, commit IDs, CI runs, and App Store states below describe the dated candidate named in their own section. They are evidence history, not the active release checklist.
