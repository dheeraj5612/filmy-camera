...
final class ProCapturePolicyTests: XCTestCase {
    ...
    private var fullCapabilities: ProCaptureOptionCapabilities {
        var capabilities = ProCaptureOptionCapabilities()
    ...
    func testUnsupportedFeaturesHaveExplicitFallbacks() {
        ...
        let result = ProCapturePolicy.resolve(options, capabilities: ProCaptureOptionCapabilities(), manualExposure: false)
